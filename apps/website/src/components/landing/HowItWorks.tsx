...
const phases: Phase[] = [
  {
    ...
    description:
      'We install @cacheplane/langchain into your Angular workspace, wire it to your LangGraph backend, and ship your first streamed response. Your team sees tokens flowing within days.',
