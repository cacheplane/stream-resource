...
export const SOLUTIONS: SolutionConfig[] = [
  {
    ...
    ctaSubtext: 'Read the docs or start a pilot. Your compliance team will thank you.',
  ...
  },
  {
    ...
    ctaSubtext: 'Read the docs or start a pilot. Ship a conversational BI experience in weeks, not quarters.',
  ...
  },
  {
    ...
    ctaSubtext: 'Read the docs or start a pilot. Resolve more tickets, escalate smarter, and keep your customers happy.',
