...
import { MockAgentTransport, agent } from '@cacheplane/angular';
import type { BaseMessage } from '@cacheplane/angular';
...
Make sure `@cacheplane/angular` is available in your test environment. MockAgentTransport ships with the main package — no extra install needed.
</Step>
